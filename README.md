...
> Maintained by [Prasad Babburi](https://github.com/PrasadBQA) · [The Testing Academy](https://thetestingacademy.com)
...
|------|---------|-----------|
| Node.js | 26.5.0 or higher | `node -v` |
| npm | 11.19.1 or higher | `npm -v` |
...
```bash
git clone https://github.com/PrasadBQA/LearningPlaywrightFundamentals.git
...
```bash
mkdir LearnPlaywrightFundamentals
cd LearnPlaywrightFundamentals
